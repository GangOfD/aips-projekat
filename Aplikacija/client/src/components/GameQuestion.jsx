...
const GameQuestion=({action})=>{
    ...
    return (
        ...
        >
          ...
          >
            <Box >
              <Lottie  style={{ width: '95%', height: '75%' }}  animationData={brainAnimation} loop={false}/>
              ...
              >
                ...
                >
                  <ArrowCircleLeft sx={{ 
                    ...
                    color: isAnimating.left? theme.palette.neutral.light: theme.palette.primary.light,
                    }}
                  />
                </IconButton>
                ...
                >
                  <ArrowCircleRight sx={{ 
                    ...
                    color: isAnimating.right? theme.palette.neutral.light: theme.palette.primary.light,
                    }} />
                </IconButton>
              </Box>
            </Box>
          ...
          <Box
            width="33%"
            minHeight="100vh"
            backgroundColor={isAnimating.right?  theme.palette.primary.main: theme.palette.primary.light}
            padding="20px"
            display="flex"
            flexDirection="column"
            justifyContent="center"
